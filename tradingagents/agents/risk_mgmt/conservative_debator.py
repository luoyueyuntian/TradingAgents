...
def _build_conservative_prompt(state, instrument_context, market_report, sentiment_report, news_report, fundamentals_report, trader_decision):
...
def create_conservative_debator(llm):
    return create_risk_debate_agent(
        llm=llm,
        prompt_builder=_build_conservative_prompt,
        owned_history_key="conservative_history",
